<%-- 
    Document   : invoice
    Created on : Nov 28, 2020, 10:57:03 PM
    Author     : Sophie
--%>
...
<form action="<c:url value='/order/displayUser' />" method="post" id="float_left">
     <input class="btn btn-outline-info btn-sm" type="submit" value="Edit Address">
</form>

<form action="<c:url value='/order/displayCreditCard' />" method="post">
     <input class="btn btn-outline-info btn-sm" type="submit" value="Continue">
</form>
