...
<section>
    ...
    <div class="dropdown dropright">
        ...
        <div class="dropdown-menu " aria-labelledby="dropdownMenuLink">
          <a class="dropdown-item" href="/JavaProject2/catalog/2/view1.jsp?page=1">Sort Alphabetically</a>
          <a class="dropdown-item" href="/JavaProject2/catalog/2/view2.jsp?page=1">Sort Alphabetically Z-A</a>
          <a class="dropdown-item" href="/JavaProject2/catalog/2/view3.jsp?page=1">Sort Highest Price</a>
          <a class="dropdown-item" href="/JavaProject2/catalog/2/view4.jsp?page=1">Sort Lowest Price</a>
          <a class="dropdown-item" href="/JavaProject2/catalog/2/view.jsp?page=1">Revert</a>
        </div>
      </div>
        <%  
...
List<Product> list= ProductDB.getRecords(pageid,total,2);
