...
public class LineItemDB {
    ...
    public static long insert(long invoiceID, LineItem lineItem) {
        ...
        String query = "INSERT INTO LineItem(InvoiceID, ProductID, Quantity, ProductName) "
                + "VALUES (?, ?, ?, ?)";
        try {
            ...
            ps.setString(4, lineItem.getProduct().getName());
    ...
    public static List<LineItem> selectLineItems(long invoiceID) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                product = ProductDB.selectProduct(productName);
